...
const BgSlider = () => {
   const [sliderPotision, setSliderPosition] = useState(50);
      ...
      <div className="pb-10 md:py-20 mx-2">
         ...
         <div className="relative w-full max-w-3xl overflow-hidden m-auto rounded-xl">
            ...
            <img
               ...
               style={{ clipPath: `inset(0 ${100.2 - sliderPotision}% 0 0)` }}
               alt=""
            />
            ...
            <img
               ...
               style={{ clipPath: `inset(0 0 0 ${sliderPotision}%)` }}
               alt=""
            />
